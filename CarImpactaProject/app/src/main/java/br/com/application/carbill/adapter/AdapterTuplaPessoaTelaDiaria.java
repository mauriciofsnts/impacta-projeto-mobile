...
public class AdapterTuplaPessoaTelaDiaria extends ArrayAdapter<ClassPessoaResumoTelaDiaria> {

    private final Context context;
    private final ArrayList<ClassPessoaResumoTelaDiaria> elementos;

    public AdapterTuplaPessoaTelaDiaria(Context context, ArrayList<ClassPessoaResumoTelaDiaria> elementos){
