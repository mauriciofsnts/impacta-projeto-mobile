...
import br.com.application.carbill.adapter.AdapterTuplaPessoaTelaInicial;
import br.com.application.carbill.model.ClassTipo;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<ClassPessoaResumoTelaInical> pessoas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddNewPerson.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, TelaAdicionarPessoa.class));
        ...
        listviewTelaInicial.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                try{
                    intent.putExtra("id_pessoa", pessoas.get(i).getIdPessoa());
    ...
    public void listarDadosTelaInicial(){
        try{
            ...
            pessoas = new ArrayList<ClassPessoaResumoTelaInical>();
            ArrayAdapter<ClassPessoaResumoTelaInical> adapter = null;
            ...
            if (meuCursor.moveToFirst()) {
                do {
                    ...
                    ClassPessoaResumoTelaInical pessoa = new ClassPessoaResumoTelaInical(id_pessoa, nome, total);
                    pessoas.add(pessoa);
...
//                Toast.makeText(this, "Tipos de viagem adicionados.", Toast.LENGTH_SHORT).show();
    ...
    public boolean tabelaTipoIsEmpty(){
        ...
        ArrayList<ClassTipo> tipos = new ArrayList<>();
        try{
            banco = openOrCreateDatabase(DATABASE_NAME, MODE_PRIVATE, null);
