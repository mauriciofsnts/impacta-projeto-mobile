...
import br.com.application.carbill.adapter.AdpterTuplaHistoricoTelaInfo;
import br.com.application.carbill.model.ClassHistoricoDeViagem;
import br.com.application.carbill.model.ClassPessoaResumoTelaInfo;
...
public class TelaInfoPerson extends AppCompatActivity {
    ...
    public ClassPessoaResumoTelaInfo pessoa;
    public ArrayList<ClassHistoricoDeViagem> viagens;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewHistorico.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                int id_viagem = viagens.get(i).getIdViagem();
        ...
        try{
            ...
            if(cursor.moveToFirst()){
                do{
                    ...
                    pessoa = new ClassPessoaResumoTelaInfo();
                    pessoa.setId_pessoa(id_pessoa);
                    pessoa.setNome(nome);
                    pessoa.setSobrenome(sobrenome);
                    pessoa.setApelido(apelido);
                    pessoa.setValorPorCorrida(valor_por_corrida);
            ...
            String valorFormatado_PorCorrida = NumberFormat.getCurrencyInstance().format(pessoa.valorPorCorrida);
            ...
            if(CursorTwo.moveToFirst()){
                do{
                    ...
                    pessoa.setDividaTotal(total);
                }while (CursorTwo.moveToNext());
            }
            CursorTwo.close();

            String valorFormatado_DividaTotal = NumberFormat.getCurrencyInstance().format(pessoa.getDividaTotal());
            ...
            viagens = new ArrayList<ClassHistoricoDeViagem>();
            ...
            if(CursorTres.moveToFirst()){
                do{
                    ...
                    ClassHistoricoDeViagem h = new ClassHistoricoDeViagem();
                    h.setIdViagem(id_viagem);
                    h.setIdTipo(id_tipo);
                    h.setData(data);
                    h.setValor(valor);
            ...
            ArrayAdapter<ClassHistoricoDeViagem> adapter = new AdpterTuplaHistoricoTelaInfo(this, viagens);
