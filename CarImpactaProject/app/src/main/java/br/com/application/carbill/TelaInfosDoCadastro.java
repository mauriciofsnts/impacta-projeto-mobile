...
import br.com.application.carbill.model.ClassPessoa;

public class TelaInfosDoCadastro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAtualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                updatePessoa();
                Toast.makeText(TelaInfosDoCadastro.this, "Atualizado com sucesso.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void listoInfos(){
        ...
        editTextValorPorCorrida.setText(String.valueOf(pessoa.getValorPorCorrida()));
        ...
        if(temDivida()){
            ...
            msgBox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    deletarPessoa();
                    finish();
                    Toast.makeText(TelaInfosDoCadastro.this, pessoa.getNome() + " " + pessoa.getSobrenome() + " foi excluido com sucesso.", Toast.LENGTH_SHORT).show();
                }
            });
            msgBox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Toast.makeText(TelaInfosDoCadastro.this, "Operação cancelada.", Toast.LENGTH_SHORT).show();
                }
            });
            msgBox.show();
        }
