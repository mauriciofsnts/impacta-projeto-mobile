...
import br.com.application.carbill.adapter.AdapterTuplaPessoaTelaDiaria;
import br.com.application.carbill.model.ClassPessoaResumoTelaDiaria;
...
public class TelaDiaria extends AppCompatActivity {
    ...
    public void retornarParaInicio() {
        startActivity(new Intent(TelaDiaria.this, MainActivity.class));
    }
    ...
    public ArrayAdapter<ClassPessoaResumoTelaDiaria> listarDadosCorridaDiaria(){

        ArrayList<ClassPessoaResumoTelaDiaria> pessoas = new ArrayList<ClassPessoaResumoTelaDiaria>();
        ...
        try{
            ...
            if (meuCursor.moveToFirst()) {
                do {
                    ...
                    ClassPessoaResumoTelaDiaria pessoa = new ClassPessoaResumoTelaDiaria(nome, id_pessoa);
                    pessoas.add(pessoa);
    ...
    void registrarCorridaDiaria(){
        for(int i=0; i<tupla_adapter.getCount(); i++){
            String nome = ((ClassPessoaResumoTelaDiaria) tupla_adapter.getItem(i)).getNome();
            boolean ida = ((ClassPessoaResumoTelaDiaria) tupla_adapter.getItem(i)).isIda();
            boolean volta = ((ClassPessoaResumoTelaDiaria) tupla_adapter.getItem(i)).isVolta();
            int id = ((ClassPessoaResumoTelaDiaria) tupla_adapter.getItem(i)).getIdPessoa();
